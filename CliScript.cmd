...
set loadBalancerIp=aw-vnet-gateway-ip
set vnetName=aw-net
...
call az network lb create -g %resourceGroup% -n %loadBalancerName% --sku Basic --vnet-name %vnetName% --public-ip-address %loadBalancerIp% --public-ip-address-allocation Static --public-ip-dns-name %loadBalancerDns%
